...
git config filter.encrypt.clean "openssl aes-256-cbc -a -salt -pass file:$HOME/.zsh/history-password"
git config filter.encrypt.smudge "openssl aes-256-cbc -d -a -salt -pass file:$HOME/.zsh/history-password"
